...
<div class="container d-flex justify-content-center align-items-center min-vh-100" onload="showAlert('${message}')">
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
        <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column"
            ...
            <div class="mb-3">
                <img src="${pageContext.request.contextPath}/img/month.png" alt="" class="img-fluid" style="width: 250px;">
            </div>
            <p class="h2">
                SIGN UP
            </p>
        ...
        <div class="col-md-6 right-box">                
            <div class="row">
                <form:form class="row g-1" name="myForm" method="post" action="${pageContext.request.contextPath}/user/signup" modelAttribute="user">
                    <div class="">
